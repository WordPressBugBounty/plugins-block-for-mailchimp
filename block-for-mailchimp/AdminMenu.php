    ...
    class mcbAdminMenu
    {
        ...
        public function adminEnqueueScripts($hook)
        {
            if ('toplevel_page_block-for-mailchimp' === $hook) {
                ...
                wp_enqueue_script('mcb-admin-script', MCB_DIR . 'dist/admin.js', ['react', 'react-dom'], MCB_PLUGIN_VERSION);
            }
        }
        ...
        public function adminMenu()
        {
            ...
            add_menu_page(
                __('Mailchimp block', 'mail-collection'),
                __('Mailchimp block', 'mail-collection'),
                'manage_options',
                'block-for-mailchimp',
                [$this, 'helpPage'],
...
add_action('wp_footer', function(){
    ...
    // var_dump(get_option( 'mcb_block_option')) ;
    // echo "alamin";
    $value = get_option( 'mcb_block_option');
    echo $value;
});