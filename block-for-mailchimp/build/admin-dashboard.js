...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/node_modules/react-router/dist/development/chunk-B7RQU5TL.mjs");
...
/* harmony export */ });
const slug = 'block-for-mailchimp';
const dashboardInfo = info => {
  ...
  return {
    name: `Block For Mailchimp ${proSuffix}`,
    displayName: `Block For Mailchimp ${proSuffix}  – Easy Mailchimp Form Integration`,
    description: 'Create a fully customizable Mailchimp subscribe form and connect your Mailchimp with your WordPress.',
    slug,
    ...
    pages: {
      ...
      landing: `https://bplugins.com/products/mailchimp-block/`,
      docs: `https://bplugins.com/docs/mailchimp-block/`,
      pricing: `https://bplugins.com/products/mailchimp-block/pricing`
    },
    freemius: {
      product_id: 16870,
      plan_id: 28132,
...
const changelogs = [{
  version: '1.1.11 – 18 April, 2025',
  list: ['Compatible with WordPress 6.8;']
}, {
  version: '1.1.10 – 11 April, 2025',
  list: ['Some issues fixed;']
}, {
  version: '1.1.9 – 9 March, 2025',
  list: ['escape richtext title, and description;']
}, {
  version: '1.1.8 – 1 March, 2025',
  list: ['Some problem fixed;']
}, {
  version: '1.1.7 – 19 Feb, 2025',
  list: ['Shortcode issues fixed;']
}];
const demoInfo = {
  title: 'Live Overview',
  description: 'Click on any section to view it live',
  allInOneLabel: 'See All Demos',
  allInOneLink: 'https://bplugins.com/products/mailchimp-block/#demos',
  demos: [{
    icon: '',
    title: 'Default',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/mailchimp-block-default/'
  }, {
    icon: '',
    title: 'Theme 1',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/mailchimp-block-formone/'
  }, {
    icon: '',
    title: 'Theme 2',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/mailchimp-block-form-two/'
  }, {
    icon: '',
    title: 'Theme 3',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/mailchimp-block-form-three/'
  }, {
    icon: '',
    title: 'Theme 4',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/mailchimp-block-form-four/'
  }, {
    icon: '',
    title: 'Theme 5',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/mailchimp-block-form-five/'
  }, {
    icon: '',
    title: 'Theme 9 Customize',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/mailchimp-block-theme-9-customize/'
  }, {
    icon: '',
    title: 'Theme 10 Customize',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/theme-10-customize/'
  }, {
    icon: '',
    title: 'Floating Top',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/floating-top/'
  }, {
    icon: '',
    title: 'Theme 5 Customize',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/theme-5-customize/'
  }, {
    icon: '',
    title: 'Theme 9 Customize',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/theme-9-customize/'
  }, {
    icon: '',
    title: 'Theme 2 Customize',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/theme-2-customize/'
  }, {
    icon: '',
    title: 'Theme 1 Customize',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/theme-1-customize/'
  }, {
    icon: '',
    title: 'Theme 8',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/theme-8/'
  }, {
    icon: '',
    title: 'Theme 7',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/theme-7/'
  }, {
    icon: '',
    title: 'Theme 6',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/theme-6/'
  }, {
    icon: '',
    title: 'Theme 5',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/theme-5/'
  }, {
    icon: '',
    title: 'Theme 4',
    description: '',
    category: '',
    type: 'iframe',
    url: 'https://b-slider.bplugins.com/demo/theme-4/'
  }]
};
const pricingInfo = {
  cycles: [
  ...
  features: ['Four layout options', 'Ten distinct themes', 'Customizable margins for labels, descriptions, and buttons', 'Added shortcode support for easy embedding', 'Multiple pattern configurations for a tailored look', 'Configurable auto-popup layout duration', 'Supports logo uploads for seamless branding'],
  button: {
    label: 'Buy Now ➜'
  },
  featured: {
...
const featureCompareInfo = {
  ...
  plans: [{
    ...
    id: 'lhmjqhkeyi',
    name: `<span style='color: #485781;'>Pro Start from </span><span style='font-size: 1.3em;'>29.99/y</span>`,
    color: '#146EF5'
  }],
  features: [{
    label: 'Responsive design. Your MailChimp forms will never look out of place, no matter which device your visitors are using.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'The label, description, first name, and last name have a show/hide option.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Emails are stored in the MailChimp dashboard. Connecting MailChimp is very easy.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'There are four forms available that you can use. You have the flexibility to customize the form layout, including changing the color, setting padding, and adjusting the border radius.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'The button text can be easily changed to your desired text. You also have the option to customize the button’s color, padding, and font typography to match your design preferences.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Certainly! With the available options, you can set the color and typography separately for the success message and error message. This allows you to customize the appearance of each message type according to your preferences.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Four layout options: Normal, Modal, Auto Popup, Floating Top, and Floating Bottom',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Ten distinct themes: Default, Theme 1, Theme 2, Theme 3, Theme 4, Theme 5, Theme 6, Theme 7, Theme 8, and Theme 9',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Customizable margins for labels, descriptions, and buttons',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Added shortcode support for easy embedding',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Multiple pattern configurations for a tailored look',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Configurable auto-popup layout duration',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Supports logo uploads for seamless branding',
    plans: ['lhmjqhkeyi']
  }]
};
...
document.addEventListener('DOMContentLoaded', () => {
  const dashboardEl = document.getElementById('mcbDashboard');
